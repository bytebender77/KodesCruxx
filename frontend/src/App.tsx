...
>>>>>>> c3c673ea (feat: add GitHub and Google OAuth with Stack Auth)
  ...
  const [currentPage, setCurrentPage] = useState<'landing' | 'features' | 'pricing' | 'how-it-works' | 'changelog' | 'docs' | 'about' | 'blog' | 'careers' | 'contact'>('landing');
...
>>>>>>> c3c673ea (feat: add GitHub and Google OAuth with Stack Auth)
  ...
  const featureBackgrounds = useMemo<Record<Feature, string>>(() => ({
    explain: '',
    debug: 'Generated Image November 19, 2025 - 1_23PM.png',
    generate: 'Generated Image November 19, 2025 - 1_24PM (1).png',
    convert: 'Generated Image November 19, 2025 - 1_24PM.png',
    complexity: 'Generated Image November 19, 2025 - 1_25PM.png',
    trace: 'Generated Image November 19, 2025 - 1_26PM.png',
    snippets: 'Generated Image November 19, 2025 - 1_27PM.png',
    projects: 'Generated Image November 19, 2025 - 1_29PM.png',
    roadmaps: 'Generated Image November 19, 2025 - 1_30PM.png',
    playground: 'Generated Image November 19, 2025 - 1_31PM.png',
    collaborate: '',
    review: 'Generated Image November 19, 2025 - 1_33PM (1).png',
    tests: 'Generated Image November 19, 2025 - 1_33PM.png',
    refactor: 'signup-visual.jpg',
  }), []);
  ...
  }, [activeFeature, featureVideos, featureBackgrounds, imageLoadErrors]);
...
>>>>>>> c3c673ea (feat: add GitHub and Google OAuth with Stack Auth)
  ...
  if (!isAuthenticated) {
    if (currentPage === 'features') {
      return <FeaturesPage onBack={() => setCurrentPage('landing')} />;
    }
    if (currentPage === 'pricing') {
      return <PricingPage onBack={() => setCurrentPage('landing')} />;
    }
    if (currentPage === 'how-it-works') {
      return <HowItWorksPage onBack={() => setCurrentPage('landing')} />;
    }
    if (currentPage === 'changelog') {
      return <ChangelogPage onBack={() => setCurrentPage('landing')} />;
    }
    if (currentPage === 'docs') {
    ...
    if (currentPage === 'blog') {
      return <BlogPage onBack={() => setCurrentPage('landing')} />;
    }
    if (currentPage === 'careers') {
      return <CareersPage onBack={() => setCurrentPage('landing')} />;
    }
    if (currentPage === 'contact') {
      return <ContactPage onBack={() => setCurrentPage('landing')} />;
    }
    return <LandingPage onNavigate={(page: 'landing' | 'features' | 'pricing' | 'how-it-works' | 'changelog' | 'docs' | 'about' | 'blog' | 'careers' | 'contact') => setCurrentPage(page)} />;
  }

  // Continue with component logic after all hooks and conditional returns
...
>>>>>>> c3c673ea (feat: add GitHub and Google OAuth with Stack Auth)
  ...
  return (
    <Layout>
      ...
      <div className="flex-1 flex flex-col container mx-auto px-4 py-4 w-full max-w-[1920px] relative z-10">
        <Header backendConnected={backendConnected} />
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          <Sidebar
            features={features}
