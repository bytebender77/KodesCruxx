            ...
            <nav className="fixed top-0 left-0 right-0 z-50 py-4 px-6 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-semibold tracking-tight text-white hidden sm:block">KodesCruxx Docs</span>
                    </div>
                </div>
                    ...
                    <div className="max-w-4xl mx-auto space-y-16 pb-20">
                        ...
                        <section id="introduction" className="scroll-mt-24">
                            <div className="mb-6">
                                ...
                                <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-6">Introduction to KodesCruxx</h1>
                                <p className="text-xl text-slate-400 leading-relaxed">
                                    KodesCruxx is an advanced AI-powered development platform designed to supercharge your coding workflow.
                                    ...
                                    KodesCruxx provides the tools you need to build faster and smarter.
                                </p>
                            </div>
                        ...
                        <section id="getting-started" className="scroll-mt-24 pt-8 border-t border-white/5">
                            ...
                            <p className="text-slate-400 mb-8">Follow these simple steps to set up your environment and start using KodesCruxx.</p>
                        ...
                        <section id="core-features" className="scroll-mt-24 pt-8 border-t border-white/5">
                            ...
                            <div className="space-y-12">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400 mb-4">
                                        Don't just find the error—understand it. KodesCruxx analyzes stack traces and code context to pinpoint the root cause of bugs.
                                    </p>
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400 mb-4">
                                        Describe what you want to build in plain English, and watch as KodesCruxx generates production-ready code, complete with comments and type definitions.
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="api-reference" className="scroll-mt-24 pt-8 border-t border-white/5">
                            ...
                            <p className="text-slate-400 mb-6">
                                Integrate KodesCruxx capabilities directly into your own tools and workflows using our REST API.
                            </p>
