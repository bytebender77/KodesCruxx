            ...
            <nav className="fixed top-0 left-0 right-0 z-50 py-6 px-6 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
                <div className="container mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-semibold tracking-tight text-white">KodesCruxx</span>
                    </div>
                    ...
                    <div className="card-animate glass-frosted p-10 md:p-16 rounded-3xl border border-white/10 mb-24 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-6 text-lg text-slate-400 leading-relaxed">
                                <p>
                                    KodesCruxx began with a simple question: "What if your IDE could understand your intent, not just your syntax?"
                                </p>
                                <p>
                                ...
                                <p>
                                    We built KodesCruxx to be the partner that handles the heavy lifting, allowing you to focus on the logic, architecture, and innovation that truly matters. Today, we are proud to support thousands of developers in building the future.
                                </p>
                            </div>
                        </div>
                    </div>
